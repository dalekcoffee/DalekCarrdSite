(function () {
  ...
  st.textContent = '*,*::before,*::after{box-sizing:border-box;margin:0;padding:0}' +
    ...
    '.lk-palify:hover,.lk-palify:active{border-color:transparent;border-image:linear-gradient(115deg,#A98146,#D9B87A,#56D8EA,#A98146) 1;box-shadow:0 0 12px rgba(169,129,70,.22),0 0 22px rgba(86,216,234,.10)}' +
    '.lk-palify:hover::before,.lk-palify:active::before{background:linear-gradient(180deg,#A98146,#D9B87A,#56D8EA)}' +
    ...
    '.lk-palify:hover .lk-icon-svg .res-line,.lk-palify:active .lk-icon-svg .res-line{stroke:url(#pal-foil)}' +
    '.lk-palify:hover .lk-icon-svg .res-fill,.lk-palify:active .lk-icon-svg .res-fill{fill:url(#pal-foil)}' +
    '.lk-palify:hover .lk-icon-svg .res-ring,.lk-palify:active .lk-icon-svg .res-ring{stroke:#56D8EA}' +
  ...
  wrap.innerHTML = '<div id="lk-card">' +
    ...
    '<a class="lk-link lk-palify" href="https://palify.org/u/dalek/collection" target="_blank" rel="noopener noreferrer" style="--brand:#A98146">' +
    '<svg class="lk-icon-svg" width="21" height="21" viewBox="0 0 24 24" fill="none" stroke="currentColor" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">' +
    '<defs><linearGradient id="pal-foil" gradientUnits="userSpaceOnUse" x1="3" y1="3" x2="21" y2="21">' +
    '<stop offset="0" stop-color="#A98146"/><stop offset=".4" stop-color="#D9B87A"/>' +
    '<stop offset=".7" stop-color="#56D8EA"/><stop offset="1" stop-color="#A98146"/>' +
    '</linearGradient></defs>' +
    '<path class="res-line" d="M12 1.6L22.4 12 12 22.4 1.6 12z" stroke-width="1.1" stroke-linejoin="round"/>' +
    '<path class="res-ring" d="M6.6 8.4a6.4 6.4 0 0 0 0 7.2M17.4 8.4a6.4 6.4 0 0 1 0 7.2" stroke-width="1.4" stroke-linecap="round"/>' +
    '<path class="res-fill" fill="currentColor" stroke="none" fill-rule="evenodd" d="M7.6 5.8H12.9C15.5 5.8 17.2 7.3 17.2 9.5C17.2 11.2 16.2 12.5 14.5 13L17.7 18.2H14.8L11.9 13.4H10.3V18.2H7.6ZM10.3 8.1V11H12.7C13.8 11 14.5 10.4 14.5 9.5C14.5 8.6 13.9 8.1 12.7 8.1Z"/>' +
    '</svg>' +
