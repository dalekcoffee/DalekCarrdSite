(function () {
  ...
  st.textContent = '*,*::before,*::after{box-sizing:border-box;margin:0;padding:0}' +
    ...
    '.lk-link.foil:hover::before,.lk-link.foil:active::before{background:linear-gradient(180deg,var(--brand,#888),var(--b-lt),var(--b-a2))}' +
    ...
    '.lk-link.rainbow.foil::after{background:linear-gradient(115deg,rgba(255,0,0,0) 10%,rgba(255,0,0,.13) 22%,rgba(255,136,0,.13) 33%,rgba(255,255,255,.10) 45%,rgba(0,204,0,.13) 57%,rgba(0,136,255,.13) 68%,rgba(136,0,255,.13) 78%,rgba(136,0,255,0) 92%)}' +
    '.lk-link.rainbow.foil:hover,.lk-link.rainbow.foil:active{border-image:linear-gradient(135deg,#f00,#f80,#ff0,#0c0,#08f,#80f) 1;box-shadow:0 0 14px rgba(100,60,200,.25),0 0 4px rgba(255,100,0,.15)}' +
    '.lk-link.rainbow.foil:hover::before,.lk-link.rainbow.foil:active::before{background:var(--rainbow)}' +
    '.lk-social.lk-tiktok.foil:hover,.lk-social.lk-tiktok.foil:active{box-shadow:-2px 0 6px rgba(238,29,82,.5),2px 0 6px rgba(105,201,208,.5)}' +
    '.lk-palify .lk-icon-svg,.lk-palify .lk-link-text,.lk-palify .lk-arrow{position:relative;z-index:2}' +
    '.lk-palify::after{content:\'\';position:absolute;top:0;right:0;bottom:0;left:0;z-index:1;pointer-events:none;opacity:0;background:linear-gradient(115deg,rgba(245,197,66,0) 10%,rgba(245,197,66,.15) 25%,rgba(155,214,122,.10) 36%,rgba(255,255,255,.10) 45%,rgba(124,198,240,.17) 55%,rgba(167,139,250,.13) 68%,rgba(245,197,66,.12) 80%,rgba(245,197,66,0) 92%);background-size:250% 100%;background-position:120% 0;transition:opacity var(--t)}' +
    '.lk-palify:hover,.lk-palify:active{border-color:transparent;border-image:linear-gradient(115deg,#f5c542,#9bd67a,#7cc6f0,#a78bfa,#f5c542) 1;box-shadow:0 0 12px rgba(245,197,66,.16),0 0 22px rgba(124,198,240,.12)}' +
    '.lk-palify:hover::before,.lk-palify:active::before{background:linear-gradient(180deg,#f5c542,#9bd67a,#7cc6f0,#a78bfa)}' +
    '.lk-palify:hover::after,.lk-palify:active::after{opacity:1;animation:pal-foil 2.6s linear infinite}' +
    '@keyframes pal-foil{0%{background-position:120% 0}100%{background-position:-20% 0}}' +
    '.lk-palify:hover .lk-icon-svg path,.lk-palify:active .lk-icon-svg path{stroke:url(#pal-foil)}' +
    '.lk-palify:hover .lk-icon-svg circle,.lk-palify:active .lk-icon-svg circle{fill:url(#pal-foil)}' +
    '@media (prefers-reduced-motion:reduce){.lk-palify:hover::after,.lk-palify:active::after{animation:none;background-position:50% 0}}';
  ...
  wrap.innerHTML = '<div id="lk-card">' +
    ...
    '<a class="lk-link rainbow foil" href="https://oshi.social/@dalekcoffee" target="_blank" rel="noopener noreferrer">' +
    ...
    '<a class="lk-link foil" href="https://discord.com/invite/h6JerzYnpY" target="_blank" rel="noopener noreferrer" style="--brand:#5865f2; --brand2:#EB459E">' +
    ...
    '<a class="lk-link foil" href="https://go.resonite.com/record/U-JustDalek-/R-019d5193-d1b1-73e1-8bbd-7dc32a2e6a6f" target="_blank" rel="noopener noreferrer" style="--brand:#c8956c; --brand2:#E8B15C">' +
    ...
    '<a class="lk-link foil" href="https://ko-fi.com/dalekcoffee" target="_blank" rel="noopener noreferrer" style="--brand:#FF5E5B; --brand2:#00B9FE">' +
    ...
    '<a class="lk-link foil" href="https://cults3d.com/en/users/DalekCoffee/3d-models" target="_blank" rel="noopener noreferrer" style="--brand:#7b3fe4; --brand2:#E44FD0">' +
    ...
    '<a class="lk-link lk-palify" href="https://palify.org/u/dalek/collection" target="_blank" rel="noopener noreferrer" style="--brand:#f5c542">' +
    '<svg class="lk-icon-svg" width="21" height="21" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round" xmlns="http://www.w3.org/2000/svg" aria-hidden="true">' +
    '<defs><linearGradient id="pal-foil" gradientUnits="userSpaceOnUse" x1="3" y1="3" x2="21" y2="21">' +
    '<stop offset="0" stop-color="#f5c542"/><stop offset=".35" stop-color="#9bd67a"/>' +
    '<stop offset=".65" stop-color="#7cc6f0"/><stop offset="1" stop-color="#a78bfa"/>' +
    '</linearGradient></defs>' +
    '<path d="M10.7 6.6A6.4 6.4 0 1 0 13.3 6.6"/>' +
    '<path d="M10.7 6.6C9 3.4 7.6 2.4 5.8 3.1 4.9 4.9 5.4 7.9 6.4 9.8"/>' +
    '<path d="M13.3 6.6C15 3.4 16.4 2.4 18.2 3.1 19.1 4.9 18.6 7.9 17.6 9.8"/>' +
    ...
    '<a class="lk-social lk-tiktok foil" href="https://www.tiktok.com/@dalekcoffee" target="_blank" rel="noopener noreferrer" style="--brand:#69c9d0; --brand2:#EE1D52">' +
    ...
    '<a class="lk-social foil" href="https://x.com/DalekCoffee" target="_blank" rel="noopener noreferrer" style="--brand:#aaa; --brand2:#E8ECF5">' +
    ...
    '<a class="lk-social foil" href="https://www.twitch.tv/dalekcoffee" target="_blank" rel="noopener noreferrer" style="--brand:#9146ff; --brand2:#E0A2FF">' +
    ...
    '<a class="lk-social foil" href="https://www.instagram.com/dalekcoffee/" target="_blank" rel="noopener noreferrer" style="--brand:#e1306c; --brand2:#F77737">' +
    ...
    '<a class="lk-social foil" href="https://bsky.app/profile/dalek.coffee" target="_blank" rel="noopener noreferrer" style="--brand:#0085ff; --brand2:#00D6E0">' +
    ...
    '<a class="lk-social foil" href="https://www.youtube.com/@DalekCoffee" target="_blank" rel="noopener noreferrer" style="--brand:#f00; --brand2:#FF4D6D">' +
    ...
    '<a class="lk-social foil" href="https://www.threads.com/@dalekcoffee" target="_blank" rel="noopener noreferrer" style="--brand:#aaa; --brand2:#E8ECF5">' +
    ...
    '<a class="lk-social foil" href="https://beamstream.gg/dalek" target="_blank" rel="noopener noreferrer" style="--brand:#285680; --brand2:#7FD4E8">' +
    ...
    '<a class="lk-social foil" href="https://fluxer.gg/Lj10zbjx" target="_blank" rel="noopener noreferrer" style="--brand:#4641d9; --brand2:#9B8CFF">' +
